...
public abstract class Drone {
    ...
    public String title(){
        return "time;lat;lng;alt;voltage;current;level;pitch;yaw;roll;vx;vy;vz;fixtype;satellitesvisible;heading;groundspeed;airspeed";
    }
    
    public String title2(){
        return "mode;system-status;armed;is-armable;ekf-ok";
    }
    ...
    public String toString2(){
        return statusUAV.mode + ";" + statusUAV.systemStatus + ";" + 
                statusUAV.armed + ";" + statusUAV.isArmable + ";" + statusUAV.ekfOk;
    }
